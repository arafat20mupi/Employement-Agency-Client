                ...
                <form className="w-full mt-[50px]" onSubmit={handleSubmit}>
                    <div className="flex flex-col sm:flex-row items-center gap-[20px]">
                        <div className="flex flex-col gap-[5px] w-full sm:w-[50%]">
                            <label className="relative">
                                ...
                                />
                                <span className="absolute -top-3 left-2 text-[#3B9DF8] bg-white transition-all duration-300">Your name</span>
                            </label>
                        </div>
                        ...
                        <div className="flex flex-col gap-[5px] w-full sm:w-[50%]">
                            <label className="relative">
                                <input
                                    ...
                                    className="peer border rounded-md outline-none px-4 py-3 w-full border-[#3B9DF8] transition-colors duration-300"
                                />
                                <span className="absolute -top-3 left-2 text-[#3B9DF8] bg-white transition-all duration-300">Company Name</span>
                            </label>
                        </div>
                    </div>
                        ...
                        <div className="flex flex-col gap-[5px] w-full sm:w-[50%]">
                            <label className="relative">
                                <input
                                    ...
                                    className="peer border rounded-md outline-none px-4 py-3 w-full border-[#3B9DF8] transition-colors duration-300"
                                />
                                <span className="absolute -top-3 left-2 text-[#3B9DF8] bg-white transition-all duration-300">Your Role</span>
                            </label>
                        </div>
                        ...
                        <div className="flex flex-col gap-[5px] w-full sm:w-[50%]">
                            <label className="relative">
                                <input
                                    ...
                                    className="peer border rounded-md outline-none px-4 py-3 w-full border-[#3B9DF8] transition-colors duration-300"
                                />
                                <span className="absolute -top-3 left-2 text-[#3B9DF8] bg-white transition-all duration-300">Your Email</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-[5px] w-full mt-[20px]">
                        <label className="relative w-full">
                            ...
                            ></textarea>
                            <span className="absolute -top-3 left-2 text-[#3B9DF8] bg-white transition-all duration-300">Your Message</span>
                        </label>
                    </div>
...
export default CanditateContact;
